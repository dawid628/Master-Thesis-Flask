...
def new_data():
    ...
    if form.validate_on_submit():
        start_time = time()  # Rozpoczęcie pomiaru czasu
        ...
        end_time = time()  # Zakończenie pomiaru czasu
        duration = end_time - start_time
        print(f"Czas wykonania dodawania danych: {duration:.2f} sekund")
...
def get_assets():
    ...
    end_time = time()  # Zakończenie pomiaru czasu
    duration = end_time - start_time
    print(f"Czas wykonania pobrania danych: {duration:.2f} sekund")
